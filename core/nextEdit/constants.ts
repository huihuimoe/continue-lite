...
export const SWEEP_FILE_SEPARATOR_TOKEN = "<|file_sep|>";
export const SWEEP_DIFF_FILE_SUFFIX = ".diff";
export const SWEEP_DIFF_ORIGINAL_LABEL = "original:";
export const SWEEP_DIFF_UPDATED_LABEL = "updated:";
export const SWEEP_ORIGINAL_FILE_PREFIX = "original/";
