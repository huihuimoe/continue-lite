...
> `@Docs`, `@Codebase`, and `@Folder` have been removed. For repository and documentation context, use the [codebase and documentation awareness guide](/guides/codebase-documentation-awareness).
...
This context provider surfaces codebase search results from the current workspace.
