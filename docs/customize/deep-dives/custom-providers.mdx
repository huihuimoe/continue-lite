...
Legacy providers such as `@Codebase`, `@Folder`, and `@Docs` have been removed.
Use the [codebase and documentation awareness guide](/guides/codebase-documentation-awareness)
for migration, and prefer MCP-backed integrations for external systems.
