...
<Tip>
Want to get started quickly? Sign up for the [Tetrate Agent Router Service](https://router.tetrate.ai/) to get an API key, then use [Tetrate on Continue Mission Control](https://continue.dev/tetrate) to get started fast.
</Tip>
...
Open [Tetrate on Continue Mission Control](https://continue.dev/tetrate) and pick a model (e.g., [Claude Sonnet 4](https://continue.dev/tetrate/claude-sonnet-4))
</Step>
...
models:
  - name: Claude Sonnet 4 - Tetrate
    ...
    capabilities:
      - tool_use
```
View the model block `tetrate/claude-sonnet-4` on the [Continue Mission Control](https://continue.dev/tetrate/claude-sonnet-4).
