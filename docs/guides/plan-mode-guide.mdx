...
`Evaluate the files under src/api, identify our REST API design patterns, and
  opportunities for better consistency.`
</Accordion>

  <Accordion title="Cross-Platform Migration">
`Plan a strategy to migrate this web app to also support mobile using React Native.`
  </Accordion>
</AccordionGroup>
</Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Refactoring & Integration">
    ...
    **API Migration**:
`Plan a migration from REST to GraphQL across our entire API.`
