...
Shared code that has abstract logic for the extension is in `core/`. Avoid importing code from `core/` directly where possible. Keep the VS Code bridge thin and use `core.invoke` to send messages to the shared runtime.
