...
const mcpServersRecordSchema = z.record(z.string(), mcpServersJsonSchema);
...
const claudeCodeLikeConfigFileSchema = z.object({
...
type claudeCodeLikeConfigFileSchema = z.infer<
